            ...
            <div class="tw-bg-white tw-px-4 tw-pt-5 tw-pb-4 sm:tw-p-6 sm:tw-pb-4">
                <div class="sm:tw-flex sm:tw-items-start">
                    ...
                    <div class="tw-mt-3 sm:tw-mt-0 sm:tw-ml-4">
                        ...
                        <p class="tw-text-sm tw-text-gray-500 tw-mb-2">{{ __('「入札を実行する」ボタンをクリックしていただくと、「' . $plan->title . '」の企画に' . $price . '円で入札することができます。') }}</p>
                        <p class="tw-text-sm tw-text-red-600">{{ __('この操作は後から取り消すことができません。') }}</p>
                    </div>
                </div>
            </div>
