        ...
        <div class=" tw-bg-white tw-rounded-lg tw-shadow-lg tw-py-6 tw-px-4 lg:tw-px-6 tw-max-w-2xl tw-mx-auto">
            <form action="{{ route('admin.plans.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="tw-mb-6">
                    ...
                    <input type="datetime-local" step="60" id="started_at" name="started_at" class="tw-shadow tw-appearance-none tw-border tw-rounded tw-w-full tw-py-2 tw-px-3 tw-text-gray-700 tw-leading-tight focus:tw-outline-none focus:tw-shadow-outline @error('started_at') tw-mb-2 tw-border-red-500 @enderror" value="{{ old('started_at') }}">
