<footer class="tw-border-t tw-border-gray-200">
    <div class="tw-container tw-flex tw-flex-col tw-flex-wrap tw-pt-16 tw-pb-4 tw-mx-auto tw-gap-8 tw-max-w-screen-lg md:tw-items-center lg:tw-items-start md:tw-flex-row md:tw-flex-nowrap">
    ...
    <div class="tw-text-center tw-mb-4">
        ...
        <div class="tw-flex tw-justify-center tw-mt-4 lg:tw-mt-2 tw-gap-x-4">
            <a class="tw-cursor-pointer">
                <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="tw-w-8 tw-h-8 tw-text-blue-600" viewBox="0 0 24 24">
                    <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
                </svg>
            </a>
            <a class="tw-cursor-pointer" href="https://twitter.com/ATOXIOS_PR" target="_blank" rel="noopener">
                <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="tw-w-8 tw-h-8 tw-text-blue-300" viewBox="0 0 24 24">
            ...
            <a class="tw-cursor-pointer" href="https://www.instagram.com/atoxios_pr" target="_blank" rel="noopener">
                <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="tw-w-8 tw-h-8 tw-text-pink-400" viewBox="0 0 24 24">
